...
const categories = ['Accesibility', 'Developer tools', 'Fun', 'News & weather', 'Photos', 'Productivity', 'Shopping', 'Social & communication',
  'Themes'];
...
// const res = setExtensionQtt(browsers, extsQtt);

const browsersRes = setBrowsersExtensionQtt(browsers, extsQtt);

console.log(browsersRes);

const categoriesRes = setAllCategoriesExtensionNum(extsQtt);
